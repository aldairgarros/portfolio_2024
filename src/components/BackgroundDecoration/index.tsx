...
export function BackgroundDecoration() {
  return (
    <div aria-hidden="true" className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
      ...
      <L
        anim="h1a 8.75s linear infinite" bs="100% 200px"
      ...
      <L
        anim="h1b 6.25s linear infinite" bs="100% 240px"
      ...
      <L
        anim="h2a 12.5s linear infinite" bs="100% 280px"
      ...
      <L
        anim="h2b 8.75s linear infinite" bs="100% 320px"
      ...
      <L
        anim="h3a 18.75s linear infinite" bs="100% 360px"
      ...
      <L
        anim="h3b 13.75s linear infinite" bs="100% 400px"
      ...
      <L
        anim="h4a 27.5s linear infinite" bs="100% 450px"
      ...
      <L
        anim="h4b 22.5s linear infinite" bs="100% 500px"
      ...
      <L
        anim="v1a 8.75s linear infinite" bs="180px 100%"
      ...
      <L
        anim="v1b 6.25s linear infinite" bs="220px 100%"
      ...
      <L
        anim="v2a 12.5s linear infinite" bs="260px 100%"
      ...
      <L
        anim="v2b 8.75s linear infinite" bs="300px 100%"
      ...
      <L
        anim="v3a 18.75s linear infinite" bs="340px 100%"
      ...
      <L
        anim="v3b 13.75s linear infinite" bs="380px 100%"
      ...
      <L
        anim="v4a 27.5s linear infinite" bs="420px 100%"
      ...
      <L
        anim="v4b 22.5s linear infinite" bs="460px 100%"
