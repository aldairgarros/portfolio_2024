...
export function BackgroundDecoration() {
  ...
  return (
    ...
    <div className="fixed inset-0 pointer-events-none" style={{ zIndex: 9999 }}>
      <motion.div className="absolute left-0 right-0 h-px dark:hidden" style={{ top: springY, background: "rgb(0 0 0 / 0.07)" }} />
      <motion.div className="absolute left-0 right-0 h-px hidden dark:block" style={{ top: springY, background: "rgb(255 255 255 / 0.05)" }} />
      <motion.div className="absolute top-0 bottom-0 w-px dark:hidden" style={{ left: springX, background: "rgb(0 0 0 / 0.07)" }} />
      <motion.div className="absolute top-0 bottom-0 w-px hidden dark:block" style={{ left: springX, background: "rgb(255 255 255 / 0.05)" }} />
    </div>
    </>);
}
